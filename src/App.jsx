...
function App() {
  ...
  const url = " http://127.0.0.1:8000/api/v1/chat_api/";
  // const url = "https://api.adinvestor.com/api/v1/chat_api/";
  ...
  const searchMutation = useMutation(
    (search) =>
      fetchWithError(url, {
        ...
        body: JSON.stringify({ message: search, api_key:'0a2c0f9c4d2772f80c7be60667472ed4' }),
      }),
    {
      onSuccess: (data) => {
        setResults((prev) => [
